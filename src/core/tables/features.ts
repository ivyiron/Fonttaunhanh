...
import { parseSvgPath, transformCommands, getExactBoundingBox } from '../geometry/path';
import { calculateAutoPosition } from '../viet/position';
import { getGroupReferenceHeights, getXHeightFromFont } from '../font/metrics';
import { VIETNAMESE_RECIPES, BASE_CHAR_RECIPES } from '../viet/recipes';
import { DiacriticTemplate, AutoPositionRules } from '../session';
 ...
 */
export { getXHeightFromFont as getXHeight } from '../font/metrics';
