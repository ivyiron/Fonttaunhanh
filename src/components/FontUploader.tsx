  ...
  return (
    <div className="w-full">
      ...
      {!metadata ? (
            ...
            <div
              ...
              className={`
                ...
                ${
                  isDragOver
                    ? 'bg-neutral-900/0'
                    : 'bg-neutral-900/0 hover:backdrop-0'
                }
        ...
        <div id="font-metadata-panel" className="bg-white dark:bg-[#1f1f2a] border border-neutral-100 dark:border-[#323242] rounded-xl p-6 shadow-xs text-neutral-900 dark:text-neutral-100">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-neutral-100 dark:border-[#2e2e3e] pb-4 mb-6 gap-4">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-neutral-50 dark:bg-[#282836] rounded-lg">
                <FileType className="w-6 h-6 text-neutral-800 dark:text-amber-400" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-neutral-950 dark:text-white">{metadata.name}</h3>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 font-mono flex items-center gap-1 mt-0.5">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3.5 py-2 text-xs font-bold bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/15 dark:hover:bg-amber-500/25 border border-amber-200 dark:border-amber-500/30 text-amber-900 dark:text-amber-300 rounded-lg transition flex items-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                id="btn-font-reset"
                onClick={onReset}
                className="px-4 py-2 text-xs font-semibold border border-neutral-200 dark:border-[#38384a] hover:bg-neutral-50 dark:hover:bg-[#282836] text-neutral-700 dark:text-neutral-200 rounded-lg transition duration-200 cursor-pointer"
              >
                Chọn font khác
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-3.5 bg-neutral-50/50 dark:bg-[#252533] rounded-lg border border-neutral-100/50 dark:border-[#323242]">
              <span className="block text-xs text-neutral-500 dark:text-neutral-400 font-medium mb-1">Family</span>
              <span className="font-semibold text-sm text-neutral-800 dark:text-neutral-100">{metadata.family}</span>
            </div>
            <div className="p-3.5 bg-neutral-50/50 dark:bg-[#252533] rounded-lg border border-neutral-100/50 dark:border-[#323242]">
              <span className="block text-xs text-neutral-500 dark:text-neutral-400 font-medium mb-1">Subfamily</span>
              <span className="font-semibold text-sm text-neutral-800 dark:text-neutral-100">{metadata.subfamily}</span>
            </div>
            <div className="p-3.5 bg-neutral-50/50 dark:bg-[#252533] rounded-lg border border-neutral-100/50 dark:border-[#323242]">
              <span className="block text-xs text-neutral-500 dark:text-neutral-400 font-medium mb-1">Units Per Em</span>
              <span className="font-semibold text-sm text-neutral-800 dark:text-neutral-100 font-mono">{metadata.unitsPerEm} UPM</span>
            </div>
            <div className="p-3.5 bg-neutral-50/50 dark:bg-[#252533] rounded-lg border border-neutral-100/50 dark:border-[#323242]">
              <span className="block text-xs text-neutral-500 dark:text-neutral-400 font-medium mb-1">Tổng số ký tự gốc</span>
              <span className="font-semibold text-sm text-neutral-800 dark:text-neutral-100 font-mono">{metadata.totalGlyphs} ký tự</span>
            </div>
          </div>

          <div className="mt-4 flex items-start gap-2 p-3 bg-neutral-50 dark:bg-[#22222e] border border-neutral-100 dark:border-[#323242] rounded-lg">
            <Info className="w-4 h-4 text-neutral-500 dark:text-amber-400 shrink-0 mt-0.5" />
